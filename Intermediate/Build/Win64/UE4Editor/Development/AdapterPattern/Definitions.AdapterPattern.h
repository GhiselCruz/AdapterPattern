...
#define UE_PROJECT_NAME AdapterPattern
#define UE_TARGET_NAME AdapterPatternEditor
#define UE_MODULE_NAME "AdapterPattern"
...
#define ADAPTERPATTERN_API DLLEXPORT
