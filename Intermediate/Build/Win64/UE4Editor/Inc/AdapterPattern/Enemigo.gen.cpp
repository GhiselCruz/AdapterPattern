...
#include "AdapterPattern/Enemigo.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	ADAPTERPATTERN_API UClass* Z_Construct_UClass_AEnemigo_NoRegister();
	ADAPTERPATTERN_API UClass* Z_Construct_UClass_AEnemigo();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AEnemigo_Statics::NewProp_EnemigoMesh = { "EnemigoMesh", nullptr, (EPropertyFlags)0x00100000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEnemigo, EnemigoMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AEnemigo_Statics::NewProp_EnemigoMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEnemigo_Statics::NewProp_EnemigoMesh_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AEnemigo_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AEnemigo_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UIAdapter_NoRegister, (int32)VTABLE_OFFSET(AEnemigo, IIAdapter), false },
		};
	...
	IMPLEMENT_CLASS(AEnemigo, 1859658355);
	template<> ADAPTERPATTERN_API UClass* StaticClass<AEnemigo>()
	{
		return AEnemigo::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AEnemigo(Z_Construct_UClass_AEnemigo, &AEnemigo::StaticClass, TEXT("/Script/AdapterPattern"), TEXT("AEnemigo"), false, nullptr, nullptr, nullptr);
